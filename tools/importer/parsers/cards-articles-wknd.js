...
/* global WebImporter */
/**
 * Parser for cards-articles-wknd. Base block: cards.
 * Source: https://wknd.site/us/en.html (recent articles image-list)
 ...
 * image link, a title link, and a description span.
 */
export default function parse(element, { document }) {
  ...
  const block = WebImporter.Blocks.createBlock(document, { name: 'cards-articles-wknd', cells });
