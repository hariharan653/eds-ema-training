...
/**
 * Transformer: wknd.site (wknd-*) section breaks and section metadata.
 * Runs in afterTransform only. Driven by payload.template.sections from
 * page-templates.json, so it is template-agnostic (works for the us-en
 * homepage template's rc2-rc11 sections and any future wknd.site template).
 *
